...
public abstract class Bag {
     ...
     *
     * @return null if there are no items in this bad and a String that is the last item added to this Bag
     */
    public String popItem(){
        if (numberOfContents == 0){
            ...
            System.arraycopy(contents, 0, newarr, 0, numberOfContents - 1);
